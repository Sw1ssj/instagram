...
const {Account, uploadVideo} = require("./instacounts");
...
function chooseRandomUsername() {
    const usernames = [
        "savagevideos", "funnymemes", "daquan","craziest.media"];
...
cron.schedule('0 8-22 * * *', async () => {
    try {
        ...
        console.error('Error occurred in scheduled function:', error);
    }
});
